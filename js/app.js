...
/* harmony import */ var _skillBar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./skillBar */ "./src/ts/skillBar.ts");
...
}
{
  /**
  * @param  {}
  * resumeのskillBarの幅を指定
  */
  Object(_skillBar__WEBPACK_IMPORTED_MODULE_4__["skillBar"])();
}
...
/*!****************************!*\
  !*** ./src/ts/skillBar.ts ***!
  \****************************/
/*! exports provided: skillBar */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "skillBar", function() { return skillBar; });
var skillBars = Array.from(document.getElementsByClassName('p-resume__skillBar'));
function skillBar() {
  for (var _i = 0, skillBars_1 = skillBars; _i < skillBars_1.length; _i++) {
    var skillBar_1 = skillBars_1[_i];
    var width = skillBar_1.getAttribute('data-width');

    if (width) {
      skillBar_1.setAttribute('style', "width: " + width + "%");
    }
  }
}
