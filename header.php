...
<html lang="ja">
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-74680718-2"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-74680718-2');
  </script>
    ...
    })(window,document,'script','dataLayer','GTM-TVHPRMB');</script>
...
<script src="<?php echo get_template_directory_uri() ?>/js/app.js" defer></script>
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TVHPRMB"
